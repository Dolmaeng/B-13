...
const dialogueData: Dialogue[][] = [
    ...
    [
        ...
        { character: '슈만', text: '이번에 들어온 신입생 중에, 실력이 좋은 친구가 들어와서 말이야. 꽤나 재미있는 곡을 썼더라고.', characterImage: '/images/schman-s.png' },
        { character: '슈만', text: '듣는 내내 네가 들으면 좋아하겠다는 생각을 했어.', characterImage: '/images/schman-s.png' },
    ...
    [
        ...
        { character: '슈만', text: '하하…고마워.', characterImage: '/images/schman-s.png' },
        ...
        { character: '나', text: '뭐, 덕분에 저도 같이 이름 좀 날려서 이번에 단독 공연도 잡혔고…', characterImage: '/images/clara-s.png', isPlayer: true },
        ...
        { character: '슈만', text: '하하, 난 네가 보고 싶을 것 같은데. 조금 섭섭하네.', characterImage: '/images/schman-s.png' },
    ...
    [
        ...
        { character: '브람스', text: '네, 모든 이야기에 선배 이름이 등장하던 걸요? 일류 작곡가 커플이라니, 정말 부러워요.', characterImage: '/images/brahms-s.png' },
    ...
    [
        ...
        { character: '나', text: '…고마워. 많이 도와줘서. 나 혼자였으면 이렇게까지 못했을 거야.', characterImage: '/images/clara-s.png', isPlayer: true },
        { character: '나', text: '이제 무대 올라가봐야 할 것 같아. 꽃다발은 준비해 뒀지? 안 예쁘면 안 받아줄 거야!', characterImage: '/images/clara-s.png', isPlayer: true },
