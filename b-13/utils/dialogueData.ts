...
const dialogueData: Dialogue[][] = [
    ...
    [
        ...
        { character: '${playerName}', text: '앗, 슈만 선배! 무슨 일이예요?', characterImage: '/images/clara.png', isPlayer: true },
    ...
    [
        ...
        { character: '${playerName}', text: '선배! 일찍 도착했네요!', characterImage: '/images/clara.png', isPlayer: true },
        { character: '', text: '(반갑게 인사를 하자, 선배가 환하게 웃으며 손을 흔들어 보인다.)', characterImage: '' },
        { character: '${playerName}', text: '요새 많이 바쁘지 않아요? 잘나가는 천재 작곡가님이 인정한 신인이라니, 궁금한데요?', characterImage: '/images/clara.png', isPlayer: true },
        { character: '슈만', text: '에이, 운이 좋았다니까! 부끄럽게 길거리에서 자꾸 그렇게 부를 거야?', characterImage: '/images/schman.png' },
        { character: '${playerName}', text: '연주자도 아니고 작곡가가 월드투어라니, 그게 얼마나 대단한 일인데요!', characterImage: '/images/clara.png', isPlayer: true },
        ...
        { character: '${playerName}', text: '미안하다는 말 그만 하라고 했죠! 선배는 경력이 있으니 스폰서가 생기는 게 당연한 거죠.', characterImage: '/images/clara.png', isPlayer: true },
        { character: '${playerName}', text: '뭐, 덕분에 저도 같이 이름 좀 날려서 이번에 단독 공연도 잡혔고…', characterImage: '/images/clara.png', isPlayer: true },
        { character: '슈만', text: '……', characterImage: '/images/schman.png' },
        { character: '', text: '(잠시 어색한 정적이 흘렀다.)', characterImage: '' },
        { character: '${playerName}', text: '…공연, 보러 못 오겠죠?', characterImage: '/images/clara.png', isPlayer: true },
        ...
        { character: '${playerName}', text: '누, 누가 무슨 걱정을 한다는 거예요! 제 공연 티켓 한 장이라도 더 팔려고 물어본 거거든요?', characterImage: '/images/clara.png', isPlayer: true },
        { character: '슈만', text: '하하, 난 네가 보고 싶을 것 같은데. 조금 섭섭하네.', characterImage: '/images/schman.png' },
        { character: '${playerName}', text: '(부끄러워하는 일러)', characterImage: '/images/clara.png', isPlayer: true },
        // { character: '화면전환', text: '(화면전환)', characterImage: '' },
    ],
    // 두번째 선택지 Scene
    [
        ...
        { character: '${playerName}', text: '어? 제 얘기를 했어요?', characterImage: '/images/clara.png', isPlayer: true },
        { character: '브람스', text: '네, 모든 이야기에 선배 이름이 등장하던 걸요? 일류 작곡가 커플이라니, 정말 부러워요.', characterImage: '/images/brahms.png' },
        { character: '${playerName}', text: '…커플?', characterImage: '/images/clara.png', isPlayer: true, textStyle: 'highlight' },
        ...
        { character: '${playerName}', text: '응?', characterImage: '/images/clara.png', isPlayer: true },
    ...
    [
        ...
        { character: '${playerName}', text: '…', characterImage: '', isPlayer: true },
    ...
    [
        ...
        { character: '${playerName}', text: '누가 떤다고 그래?', characterImage: '/images/clara.png', isPlayer: true },
        { character: '${playerName}', text: '…고마워. 많이 도와줘서. 나 혼자였으면 이렇게까지 못했을 거야.', characterImage: '/images/clara.png', isPlayer: true },
        { character: '${playerName}', text: '이제 무대 올라가봐야 할 것 같아. 꽃다발은 준비해 뒀지? 안 예쁘면 안 받아줄 거야!', characterImage: '/images/clara.png', isPlayer: true },
    ...
    [
        ...
        { character: '${playerName}', text: '…슈만…선배…?', characterImage: '/images/clara.png', isPlayer: true, background:'/images/background-schmanSit.jpg' },
   ...
   [
    ...
    { character: '${playerName}', text: '바쁠 텐데…어떻게 온거예요?', characterImage: '/images/clara.png', isPlayer: true },
    ...
    { character: '${playerName}', text: '오랜만에 겨우 만났는데…겨우 그게 전부예요?', characterImage: '/images/clara.png', isPlayer: true },
...
[
    ...
    { character: '${playerName}', text: '하하, 예쁜 걸로 준비하라고 했더니, 정말 큰 걸로도 준비했네.', characterImage: '/images/clara.png', isPlayer: true },
    { character: '브람스', text: '당연하죠. 선배한테 주는 건데.', characterImage: '/images/brahms.png' },
    { character: '${playerName}', text: '좋아, 합격! 받아 줄게! …그리고, 네 마음도.', characterImage: '/images/clara.png', isPlayer: true },
    { character: '브람스', text: '네? 박수소리가 너무 커서 잘 안 들리는데, 한 번만 더 말해줄 수 있어요?', characterImage: '/images/brahms.png' },
    { character: '${playerName}', text: '너, 일부러 그러는 거지?', characterImage: '/images/clara.png', isPlayer: true },
